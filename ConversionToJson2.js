...
learnLine.on('line', function (line) 																		//Using call back method with line event, we read the data line by line
{
	...
	else
	{
		...
		set[header[11].replace(/\"/g,"")] = presentLine[11].replace(/\"/g,""); 								//store the fetched data's in set object
...
{ 
	learnData.appendFile('barchart2.json',JSON.stringify(sqr), function(err) 								//To append the fetched data into a json file
	{ 
